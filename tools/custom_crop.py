...
for img in imgs:
    ...
    rgb_img2 = Image.open(os.path.join(r'd:\Research\2- Research (DeepForest)\denisty_check_final_revision\Scene_222223\FP', str(num) + '.png'))
    ...
    cropped_rgb_image2.save(os.path.join(r'd:\Research\2- Research (DeepForest)\denisty_check_final_revision\Scene_222223\FP_cropped', str(num) + '.png'))
    index += 1
