...
for img in imgs:
    ...
    rgb_img2 = Image.open(os.path.join(r'd:\Research\2- Research (DeepForest)\Update\data\Scene_515\ZS', img))
    ...
    cropped_rgb_image2.save(os.path.join(r'd:\Research\2- Research (DeepForest)\Update\data\Scene_515\ZS_cropped', img))
    index += 1
